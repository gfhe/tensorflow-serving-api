...
public final class CompositeTensorVariant {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(tensorflow.CompositeTensorVariant.CompositeTensorVariantMetadata result) {
      ...
      public Builder mergeTypeSpecProto(tensorflow.Struct.TypeSpecProto value) {
        if (typeSpecProtoBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            typeSpecProto_ != null &&
            typeSpecProto_ != tensorflow.Struct.TypeSpecProto.getDefaultInstance()) {
