...
public final class ReplayLog {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(tensorflow.ReplayLog.NewReplaySession result) {
      ...
      public Builder mergeDevices(org.tensorflow.distruntime.ListDevicesResponse value) {
        if (devicesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            devices_ != null &&
            devices_ != org.tensorflow.distruntime.ListDevicesResponse.getDefaultInstance()) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private double startTimeUs_ = 0D;
    /**
     * <code>double start_time_us = 31;</code>
     * @return The startTimeUs.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (java.lang.Double.doubleToRawLongBits(startTimeUs_) != 0) {
        output.writeDouble(31, startTimeUs_);
      }
      if (java.lang.Double.doubleToRawLongBits(endTimeUs_) != 0) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(tensorflow.ReplayLog.ReplayOp result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartialOneofs(tensorflow.ReplayLog.ReplayOp result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    getCreateSessionFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 1;
                break;
              } // case 10
              case 18: {
                input.readMessage(
                    getExtendSessionFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 2;
                break;
              } // case 18
              case 26: {
                input.readMessage(
                    getPartialRunSetupFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 3;
                break;
              } // case 26
              case 34: {
                input.readMessage(
                    getRunStepFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 4;
                break;
              } // case 34
              ...
              case 50: {
                input.readMessage(
                    getListDevicesFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 6;
                break;
              } // case 50
              case 58: {
                input.readMessage(
                    getResetRequestFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 7;
                break;
              } // case 58
              case 66: {
                input.readMessage(
                    getMakeCallableFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 8;
                break;
              } // case 66
              case 74: {
                input.readMessage(
                    getRunCallableFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 9;
                break;
              } // case 74
              case 82: {
                input.readMessage(
                    getReleaseCallableFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 10;
                break;
              } // case 82
              case 90: {
                input.readMessage(
                    getNewReplaySessionFieldBuilder().getBuilder(),
                    extensionRegistry);
                opCase_ = 11;
                break;
              } // case 90
              case 170: {
                input.readMessage(
                    getCreateSessionResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 21;
                break;
              } // case 170
              case 178: {
                input.readMessage(
                    getExtendSessionResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 22;
                break;
              } // case 178
              case 186: {
                input.readMessage(
                    getPartialRunSetupResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 23;
                break;
              } // case 186
              case 194: {
                input.readMessage(
                    getRunStepResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 24;
                break;
              } // case 194
              case 202: {
                input.readMessage(
                    getCloseSessionResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 25;
                break;
              } // case 202
              case 210: {
                input.readMessage(
                    getListDevicesResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 26;
                break;
              } // case 210
              case 218: {
                input.readMessage(
                    getResetRequestResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 27;
                break;
              } // case 218
              case 226: {
                input.readMessage(
                    getMakeCallableResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 28;
                break;
              } // case 226
              case 234: {
                input.readMessage(
                    getRunCallableResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 29;
                break;
              } // case 234
              case 242: {
                input.readMessage(
                    getReleaseCallableResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                responseCase_ = 30;
                break;
              } // case 242
