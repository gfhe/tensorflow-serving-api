...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.distruntime.LoggingResponse result) {
      if (stepBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.distruntime.LoggingResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.distruntime.LabeledStepStats m =
                  input.readMessage(
                      org.tensorflow.distruntime.LabeledStepStats.parser(),
                      extensionRegistry);
              if (stepBuilder_ == null) {
                ensureStepIsMutable();
                step_.add(m);
