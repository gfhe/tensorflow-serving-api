...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.distruntime.ClusterDef result) {
      if (jobBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.distruntime.ClusterDef result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.distruntime.JobDef m =
                  input.readMessage(
                      org.tensorflow.distruntime.JobDef.parser(),
                      extensionRegistry);
              if (jobBuilder_ == null) {
                ensureJobIsMutable();
                job_.add(m);
