...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tensorflow.util.StackFrameWithId result) {
    ...
    public Builder mergeFileLineCol(org.tensorflow.framework.GraphDebugInfo.FileLineCol value) {
      if (fileLineColBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          fileLineCol_ != null &&
          fileLineCol_ != org.tensorflow.framework.GraphDebugInfo.FileLineCol.getDefaultInstance()) {
