...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.util.testlog.MachineConfiguration result) {
      if (deviceInfoBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.util.testlog.MachineConfiguration result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              org.tensorflow.util.testlog.AvailableDeviceInfo m =
                  input.readMessage(
                      org.tensorflow.util.testlog.AvailableDeviceInfo.parser(),
                      extensionRegistry);
              if (availableDeviceInfoBuilder_ == null) {
                ensureAvailableDeviceInfoIsMutable();
    ...
    public Builder mergePlatformInfo(org.tensorflow.util.testlog.PlatformInfo value) {
      if (platformInfoBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          platformInfo_ != null &&
          platformInfo_ != org.tensorflow.util.testlog.PlatformInfo.getDefaultInstance()) {
    ...
    public Builder mergeCpuInfo(org.tensorflow.util.testlog.CPUInfo value) {
      if (cpuInfoBuilder_ == null) {
        if (((bitField0_ & 0x00000008) != 0) &&
          cpuInfo_ != null &&
          cpuInfo_ != org.tensorflow.util.testlog.CPUInfo.getDefaultInstance()) {
    ...
    public Builder mergeMemoryInfo(org.tensorflow.util.testlog.MemoryInfo value) {
      if (memoryInfoBuilder_ == null) {
        if (((bitField0_ & 0x00000040) != 0) &&
          memoryInfo_ != null &&
          memoryInfo_ != org.tensorflow.util.testlog.MemoryInfo.getDefaultInstance()) {
