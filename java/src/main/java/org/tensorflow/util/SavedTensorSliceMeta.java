...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.util.SavedTensorSliceMeta result) {
      if (tensorBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.util.SavedTensorSliceMeta result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.util.SavedSliceMeta m =
                  input.readMessage(
                      org.tensorflow.util.SavedSliceMeta.parser(),
                      extensionRegistry);
              if (tensorBuilder_ == null) {
                ensureTensorIsMutable();
                tensor_.add(m);
