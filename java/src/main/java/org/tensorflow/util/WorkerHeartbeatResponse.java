...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override public org.tensorflow.util.WorkerHealth getHealthStatus() {
    org.tensorflow.util.WorkerHealth result = org.tensorflow.util.WorkerHealth.forNumber(healthStatus_);
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.util.WorkerHeartbeatResponse result) {
      if (workerLogBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.util.WorkerHeartbeatResponse result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              org.tensorflow.util.Event m =
                  input.readMessage(
                      org.tensorflow.util.Event.parser(),
                      extensionRegistry);
              if (workerLogBuilder_ == null) {
                ensureWorkerLogIsMutable();
                workerLog_.add(m);
