...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.util.BundleEntryProto result) {
      if (slicesBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.util.BundleEntryProto result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58: {
              org.tensorflow.framework.TensorSliceProto m =
                  input.readMessage(
                      org.tensorflow.framework.TensorSliceProto.parser(),
                      extensionRegistry);
              if (slicesBuilder_ == null) {
                ensureSlicesIsMutable();
                slices_.add(m);
