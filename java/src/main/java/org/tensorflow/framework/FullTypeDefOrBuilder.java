...
public interface FullTypeDefOrBuilder extends
   ...
   * @return The typeId.
   */
  org.tensorflow.framework.FullTypeId getTypeId();

  /**
   * <code>repeated .tensorflow.FullTypeDef args = 2;</code>
   */
  java.util.List<org.tensorflow.framework.FullTypeDef> 
      getArgsList();
  /**
   * <code>repeated .tensorflow.FullTypeDef args = 2;</code>
   */
  org.tensorflow.framework.FullTypeDef getArgs(int index);
  /**
   * <code>repeated .tensorflow.FullTypeDef args = 2;</code>
   */
  int getArgsCount();
   ...
   * <code>repeated .tensorflow.FullTypeDef args = 2;</code>
   */
  java.util.List<? extends org.tensorflow.framework.FullTypeDefOrBuilder> 
      getArgsOrBuilderList();
  /**
   * <code>repeated .tensorflow.FullTypeDef args = 2;</code>
   */
  org.tensorflow.framework.FullTypeDefOrBuilder getArgsOrBuilder(
      int index);
  ...
  public org.tensorflow.framework.FullTypeDef.AttrCase getAttrCase();
}
