...
private static final long serialVersionUID = 0L;
  ...
  @SuppressWarnings("serial")
  private java.util.List<org.tensorflow.framework.RegisteredGradient> registeredGradients_;
  /**
   * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
   */
  @java.lang.Override
  public java.util.List<org.tensorflow.framework.RegisteredGradient> getRegisteredGradientsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends org.tensorflow.framework.RegisteredGradientOrBuilder> 
   ...
   */
  @java.lang.Override
  public org.tensorflow.framework.RegisteredGradient getRegisteredGradients(int index) {
   ...
   */
  @java.lang.Override
  public org.tensorflow.framework.RegisteredGradientOrBuilder getRegisteredGradientsOrBuilder(
      int index) {
    return registeredGradients_.get(index);
  }
  ...
  public static final class Builder extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              org.tensorflow.framework.RegisteredGradient m =
                  input.readMessage(
                      org.tensorflow.framework.RegisteredGradient.parser(),
                      extensionRegistry);
              if (registeredGradientsBuilder_ == null) {
                ensureRegisteredGradientsIsMutable();
    ...
    private void ensureRegisteredGradientsIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        registeredGradients_ = new java.util.ArrayList<org.tensorflow.framework.RegisteredGradient>(registeredGradients_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        org.tensorflow.framework.RegisteredGradient, org.tensorflow.framework.RegisteredGradient.Builder, org.tensorflow.framework.RegisteredGradientOrBuilder> registeredGradientsBuilder_;
    ...
    public Builder setRegisteredGradients(
        int index, org.tensorflow.framework.RegisteredGradient value) {
      if (registeredGradientsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
     */
    public Builder addRegisteredGradients(org.tensorflow.framework.RegisteredGradient value) {
      if (registeredGradientsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addRegisteredGradients(
        org.tensorflow.framework.RegisteredGradient.Builder builderForValue) {
      if (registeredGradientsBuilder_ == null) {
        ensureRegisteredGradientsIsMutable();
    ...
    public Builder addAllRegisteredGradients(
        java.lang.Iterable<? extends org.tensorflow.framework.RegisteredGradient> values) {
      if (registeredGradientsBuilder_ == null) {
        ensureRegisteredGradientsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
     */
    public org.tensorflow.framework.RegisteredGradient.Builder getRegisteredGradientsBuilder(
        int index) {
     ...
     * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
     */
    public org.tensorflow.framework.RegisteredGradient.Builder addRegisteredGradientsBuilder() {
      return getRegisteredGradientsFieldBuilder().addBuilder(
          org.tensorflow.framework.RegisteredGradient.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
     */
    public org.tensorflow.framework.RegisteredGradient.Builder addRegisteredGradientsBuilder(
        int index) {
      return getRegisteredGradientsFieldBuilder().addBuilder(
          index, org.tensorflow.framework.RegisteredGradient.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
     */
    public java.util.List<org.tensorflow.framework.RegisteredGradient.Builder> 
         getRegisteredGradientsBuilderList() {
      return getRegisteredGradientsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        org.tensorflow.framework.RegisteredGradient, org.tensorflow.framework.RegisteredGradient.Builder, org.tensorflow.framework.RegisteredGradientOrBuilder> 
