...
public interface FunctionDefLibraryOrBuilder extends
   ...
   */
  java.util.List<org.tensorflow.framework.RegisteredGradient> 
      getRegisteredGradientsList();
  /**
   * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
   */
  org.tensorflow.framework.RegisteredGradient getRegisteredGradients(int index);
  /**
   * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
   */
   ...
   * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
   */
  java.util.List<? extends org.tensorflow.framework.RegisteredGradientOrBuilder> 
      getRegisteredGradientsOrBuilderList();
  /**
   * <code>repeated .tensorflow.RegisteredGradient registered_gradients = 3;</code>
   */
  org.tensorflow.framework.RegisteredGradientOrBuilder getRegisteredGradientsOrBuilder(
      int index);
}
