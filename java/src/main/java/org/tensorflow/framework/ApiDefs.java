...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.ApiDefs result) {
      if (opBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.ApiDefs result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.framework.ApiDef m =
                  input.readMessage(
                      org.tensorflow.framework.ApiDef.parser(),
                      extensionRegistry);
              if (opBuilder_ == null) {
                ensureOpIsMutable();
                op_.add(m);
