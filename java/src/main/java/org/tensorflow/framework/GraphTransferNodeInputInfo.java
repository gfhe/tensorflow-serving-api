...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.GraphTransferNodeInputInfo result) {
      if (nodeInputBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.GraphTransferNodeInputInfo result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              org.tensorflow.framework.GraphTransferNodeInput m =
                  input.readMessage(
                      org.tensorflow.framework.GraphTransferNodeInput.parser(),
                      extensionRegistry);
              if (nodeInputBuilder_ == null) {
                ensureNodeInputIsMutable();
                nodeInput_.add(m);
