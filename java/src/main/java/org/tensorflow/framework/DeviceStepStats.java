...
java.lang.String defaultValue) {
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.DeviceStepStats result) {
      if (nodeStatsBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.DeviceStepStats result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              org.tensorflow.framework.NodeExecStats m =
                  input.readMessage(
                      org.tensorflow.framework.NodeExecStats.parser(),
                      extensionRegistry);
              if (nodeStatsBuilder_ == null) {
                ensureNodeStatsIsMutable();
                nodeStats_.add(m);
