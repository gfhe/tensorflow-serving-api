      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114: {
              org.tensorflow.framework.ResourceHandleProto m =
                  input.readMessage(
                      org.tensorflow.framework.ResourceHandleProto.parser(),
                      extensionRegistry);
              if (resourceHandleValBuilder_ == null) {
                ensureResourceHandleValIsMutable();
            ...
            case 122: {
              org.tensorflow.framework.VariantTensorDataProto m =
                  input.readMessage(
                      org.tensorflow.framework.VariantTensorDataProto.parser(),
                      extensionRegistry);
              if (variantValBuilder_ == null) {
                ensureVariantValIsMutable();
                variantVal_.add(m);
