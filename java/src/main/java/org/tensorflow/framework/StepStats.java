...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.StepStats result) {
      if (devStatsBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.StepStats result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.framework.DeviceStepStats m =
                  input.readMessage(
                      org.tensorflow.framework.DeviceStepStats.parser(),
                      extensionRegistry);
              if (devStatsBuilder_ == null) {
                ensureDevStatsIsMutable();
                devStats_.add(m);
