...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.DebuggedSourceFiles result) {
      if (sourceFilesBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.DebuggedSourceFiles result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.framework.DebuggedSourceFile m =
                  input.readMessage(
                      org.tensorflow.framework.DebuggedSourceFile.parser(),
                      extensionRegistry);
              if (sourceFilesBuilder_ == null) {
                ensureSourceFilesIsMutable();
                sourceFiles_.add(m);
