...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.SavedModel result) {
      if (metaGraphsBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.SavedModel result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              org.tensorflow.framework.MetaGraphDef m =
                  input.readMessage(
                      org.tensorflow.framework.MetaGraphDef.parser(),
                      extensionRegistry);
              if (metaGraphsBuilder_ == null) {
                ensureMetaGraphsIsMutable();
                metaGraphs_.add(m);
