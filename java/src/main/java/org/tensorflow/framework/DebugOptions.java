...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.DebugOptions result) {
      if (debugTensorWatchOptsBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.DebugOptions result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 34: {
              org.tensorflow.framework.DebugTensorWatch m =
                  input.readMessage(
                      org.tensorflow.framework.DebugTensorWatch.parser(),
                      extensionRegistry);
              if (debugTensorWatchOptsBuilder_ == null) {
                ensureDebugTensorWatchOptsIsMutable();
