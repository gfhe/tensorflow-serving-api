...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tensorflow.framework.LocalLinks result) {
      if (linkBuilder_ == null) {
    ...
    private void buildPartial0(org.tensorflow.framework.LocalLinks result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.framework.InterconnectLink m =
                  input.readMessage(
                      org.tensorflow.framework.InterconnectLink.parser(),
                      extensionRegistry);
              if (linkBuilder_ == null) {
                ensureLinkIsMutable();
                link_.add(m);
