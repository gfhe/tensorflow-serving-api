<div align="center">
    <img src="https://raw.githubusercontent.com/gfhe/tensorflow-serving-api/master/images/golang.png"
...
1. Clone this project to your local dir with the following command.
   ...
   ```shell
   git clone https://github.com/gfhe/tensorflow-serving-api.git
   git submodule init
   git submodule update
   # or
   git clone --recurse-submodules https://github.com/gfhe/tensorflow-serving-api.git
   ```
